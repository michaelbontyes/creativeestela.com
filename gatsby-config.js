  ...
  plugins: [
    {
      ...
      options: {
         ...
         */
        baseUrl: "creativeestela.wordpress.com",
        ...
        searchAndReplaceContentUrls: {
          sourceUrl: "https://creativeestela.wordpress.com",
          replacementUrl: "https://creativeestela.com",
        },
    ...
    },
    {
      ...
      options: {
        fonts: [
          `Muli:200,300,400,400i,500,700,800` // you can also specify font weights and styles
        ],
        display: 'swap'
      }
    },
