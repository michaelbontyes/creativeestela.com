              ...
              {posts.map(({ node: post }) => (
                <div>
                  <div className="uk-card" key={post.id}>
                    ...
                    <div className="post-meta uk-margin-top uk-margin-bottom uk-padding-small-right uk-padding-small-left">
                      <div class="uk-flex uk-flex-top uk-text-center">
                        <div class="uk-card uk-text-left uk-width-expand">
                          <div
                            className="content"
                            dangerouslySetInnerHTML={{ __html: post.excerpt }}
                          />
                        </div>
                        <div class="uk-card uk-margin-left uk-text-right uk-width-auto">
                            <Link to={post.slug}>
                    ...
                    <div className="post-meta uk-margin-bottom uk-padding-small-right uk-padding-small-left">
                      <div class="uk-flex uk-flex-top uk-text-center">
                        <div class="uk-card uk-text-left uk-width-expand">
